...
// Cloudflare bot protection on OpenAI endpoints rejects requests that ship
// with the default Node undici User-Agent. Matching the official Codex CLI
// format gets us through the WAF.
...
server.listen(PORT, "127.0.0.1", () => {
  console.log(`GPT for Claude Code Proxy v2.1.9 on http://127.0.0.1:${PORT}`);
