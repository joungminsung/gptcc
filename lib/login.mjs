...
// These values are what OpenAI expects on the authorize request for the
// public Codex CLI client_id. Changing them will cause the authorize
// server to reject the request with `missing_required_parameter`.
// Source: openai/codex-rs/login/src/server.rs build_authorize_url().
const SCOPE =
